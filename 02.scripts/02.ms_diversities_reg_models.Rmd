...
load("C:/Users/catia/Desktop/ms_diversities/01.input_data/01.diversity_env_df.RData")
```
...
wc_beta_mean <- div_env_df %>% 
  filter(scale == "beta", group == "Whole-community", year == "Mean")
wc_beta_2016 <- div_env_df %>% 
  filter(scale == "beta", group == "Whole-community", year == "2016")
wc_beta_2017 <- div_env_df %>% 
  filter(scale == "beta", group == "Whole-community", year == "2017")
wc_beta_2018 <- div_env_df %>% 
  filter(scale == "beta", group == "Whole-community", year == "2018")
...
bact_beta_mean <- div_env_df %>% 
  filter(scale == "beta", group == "Bacteria", year == "Mean")
bact_beta_2016 <- div_env_df %>% 
  filter(scale == "beta", group == "Bacteria", year == "2016")
bact_beta_2017 <- div_env_df %>% 
  filter(scale == "beta", group == "Bacteria", year == "2017")
bact_beta_2018 <- div_env_df %>% 
  filter(scale == "beta", group == "Bacteria", year == "2018")
...
phyto_beta_mean <- div_env_df %>% 
  filter(scale == "beta", group == "Phytoplankton", year == "Mean")
phyto_beta_2016 <- div_env_df %>% 
  filter(scale == "beta", group == "Phytoplankton", year == "2016")
phyto_beta_2017 <- div_env_df %>% 
  filter(scale == "beta", group == "Phytoplankton", year == "2017")
phyto_beta_2018 <- div_env_df %>% 
  filter(scale == "beta", group == "Phytoplankton", year == "2018")
...
zoo_beta_mean <- div_env_df %>% 
  filter(scale == "beta", group == "Zooplankton", year == "Mean")
zoo_beta_2016 <- div_env_df %>% 
  filter(scale == "beta", group == "Zooplankton", year == "2016")
zoo_beta_2017 <- div_env_df %>% 
  filter(scale == "beta", group == "Zooplankton", year == "2017")
zoo_beta_2018 <- div_env_df %>% 
  filter(scale == "beta", group == "Zooplankton", year == "2018")
...
macro_beta_mean <- div_env_df %>% 
  filter(scale == "beta", group == "Macroinvertebrates", year == "Mean")
macro_beta_2016 <- div_env_df %>% 
  filter(scale == "beta", group == "Macroinvertebrates", year == "2016")
macro_beta_2017 <- div_env_df %>% 
  filter(scale == "beta", group == "Macroinvertebrates", year == "2017")
macro_beta_2018 <- div_env_df %>% 
  filter(scale == "beta", group == "Macroinvertebrates", year == "2018")
...
setwd("C:/Users/catia/Desktop/ms_diversities/03.output_data")
write.csv(x = mods_linear, file = paste("02.linear_models_evaluation.csv", sep = ""))
write.csv(x = mods_quadratic, file = paste("02.quadratic_models_evaluation.csv", sep = ""))
```
