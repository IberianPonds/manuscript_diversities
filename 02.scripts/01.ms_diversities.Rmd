...
# Introduction
We combined environmental DNA and morphological surveys from a multi-region freshwater mesocosm experiment spanning a broad temperature gradient across the Iberian Peninsula to examine how mean temperature and its variability shape multi-trophic aquatic communities. This script reproduces the figures in the main text of the manuscript and in the supplements.
...
```{r}
# community data
community.df <- read.csv("../input_data/hybrid_geo_fit_tax_res.csv", sep = ";", header = T)
...
div_env_df <- rbind(alpha_div, gamma_div, beta_sn_div)
