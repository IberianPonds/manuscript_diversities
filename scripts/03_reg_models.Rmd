...
write.csv(x = mods_linear, file = paste("../outputs/02.linear_models_evaluation.csv", sep = ""))
write.csv(x = mods_quadratic, file = paste("../outputs/02.quadratic_models_evaluation.csv", sep = ""))
```
