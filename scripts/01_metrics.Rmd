...
for (i in 1:nrow(hybrid_matrix2)) {
  hybrid_matrix2[, 405] <- sum(hybrid_matrix2[i, 405], hybrid_matrix2[i, 614])
}
...
environmental_variables$sample_code[281] # TL_17_17
environmental_variables$temp[281] <- mean(environmental_variables$temp)
